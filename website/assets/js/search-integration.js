...
(function() {
    ...
    function initSearchIntegration() {
        if (typeof window.CaxtonSearch !== 'undefined' && typeof window.ADRSearch !== 'undefined') {
            console.log('Search Integration: Bridging enhanced search with ADR search');
            ...
            console.log('Search Integration: Successfully integrated enhanced search with ADR search');
        } else {
    ...
    window.SearchIntegration = {
        isReady: () => typeof window.CaxtonSearch !== 'undefined' && typeof window.ADRSearch !== 'undefined',
