...
```bash
# Reply to specific review comment (NOT top-level PR comment)
gh api repos/{owner}/{repo}/pulls/comments/{comment-id}/replies \
  --method POST \
  --field body="""<!-- Generated by Claude Code -->

**🤖 Claude Code**: [response to specific review point]

_This comment was generated automatically by Claude Code in response to the
review feedback above._"""
```
...
#### 4.4 Enhanced Comment Attribution Format

**For CI failure updates (top-level PR comments):**

```markdown
<!-- Generated by Claude Code -->

**🤖 Claude Code**: CI build failure detected and being addressed:

[failure details and resolution steps]

_This comment was generated automatically by Claude Code. CI issues take
priority over review feedback._
```

**For threaded review replies:**
...
### 5. Enhanced PR Review Workflow (MANDATORY)
