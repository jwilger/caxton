...
-- databases that may already contain this table from legacy deployments
-- or manual schema initialization. This ensures graceful migration
-- behavior without conflicts.
--
-- Schema Design:
